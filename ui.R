  ...
  navbarPage(
   ...
   tabPanel(
      ...
      sidebarPanel(
        ...
        br(), br(),
        "Julkowska, M.M., Saade, S., Agarwal, G., Gao, G., Morton, M.J.L., Awlia, M., Pailles, Y., Tester, M., MVApp.pre-release_v2.0 mmjulkowska/MVApp: MVApp.pre-release_v2.0, DOI: 10.5281/zenodo.1067974",
        br(), br(),
