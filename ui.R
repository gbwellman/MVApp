...
tabPanel("K-means Clustering", icon = icon("barcode"),
         sidebarPanel(
           ...
           hr(),
           #uiOutput("Select_number_of_clusters_to_perform"),
         ...
         mainPanel(
           navbarPage("KMC",
                      ...
                      tabPanel("Optimal number of clusters",
                               p("The optimal number of clusters is somehow subjective and depends on the method used for measuring similarities and the parameters used for partitioning.
