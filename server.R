function(input, output) {
  ...
  output$Legend_histo <- renderPrint({
    ...
    which_hist_yaxis<-input$HistType
    ...
    cat("\n")
    if(input$plot_facet == T){
    cat("The plot represents the", which_hist_yaxis, "of", which_hist_DV, "stacked by", which_hist_IV, "and facetted by", which_plotfacets, "using", which_hist_data,".")  
    }
    if(input$plot_facet == F){
      cat("The plot represents the", which_hist_yaxis, "of", which_hist_DV, "stacked by", which_hist_IV, "using", which_hist_data,".")  
    }
  ...
  output$legend_QQ_show <- renderPrint({
    ...
    cat("\n")
    if(input$plot_facet == T){
      cat("The plot represents the QQ plot of", which_hist_DV, "by", which_hist_IV, "and", which_plotfacets, "using", which_hist_data,".")  
    }
    if(input$plot_facet == F){
      cat("The plot represents the QQ plot of", which_hist_DV, "by", which_hist_IV, "using", which_hist_data,".")  
    }
